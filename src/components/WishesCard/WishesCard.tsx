  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Text size={'md'} variant={'greyBlue'}>
        Будем рады, если вместо цветов вы решите подарить бутылочку хорошего вина или другого алкоголя.
      </Text>
      <hr className={styles.hr}/>
      <Text size={'md'} variant={'greyBlue'}>
        Если хотите подарить ценный и нужный подарок, буду очень благодарна за вклад в бюджет грядущего путешествия.
      </Text>
    </div>
  );
};